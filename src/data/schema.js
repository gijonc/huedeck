...
import {
	schema as AdminDbSchema,
	resolvers as AdminDbResolvers,
	mutations as AdminDbMutations,
	queries as AdminDbQueries,
} from './graphql/AdminDB/schema';
...
const resolvers = merge(DatabaseResolvers, AdminDbResolvers);
